Shader "Hidden/XPostProcessing/Vignette/RapidOldTVVignette"
{
    HLSLINCLUDE
    ...
    half4 Frag_Vignette(Varyings_Vignette i) : SV_Target
    {
        ...
        float2 tvUV = i.texcoord.zw * i.texcoord.zw;
        //求解vignette强度
        half vignetteIndensity = saturate(1.0 - dot(tvUV, tvUV) * _VignetteIndensity * 20);
