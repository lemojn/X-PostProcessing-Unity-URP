Shader "Hidden/XPostProcessing/Vignette/AuroraVignette"
{
    HLSLINCLUDE
    ...
    half4 Frag_AuroraVignette(Varyings i) : SV_Target
    {
        ...
        half3 finalColor = lerp(GetScreenColor(uv).rgb, AuroraColor, vignetteIndensity * _Fading);
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag_AuroraVignette
