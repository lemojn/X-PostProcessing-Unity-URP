Shader "Hidden/XPostProcessing/Pixelate/PixelizeLed"
{
    HLSLINCLUDE
    ...
    half4 Frag_PixelizeLed(Varyings i) : SV_Target
    {
        // 实现矩形像素效果
        float2 uv = RectPixelizeUV(i.texcoord);
        half4 color = GetScreenColor(uv);
        // 计算矩形像素坐标
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag_PixelizeLed
