...
{
    [VolumeComponentMenu(VolumeMenu.Blur + "双重方框模糊 (Dual Box Blur)")]
    public class DualBoxBlur : VolumeSettingBase
    {
    ...
    [VolumeRendererPriority(VolumePriority.Blur + 40)]
    public class DualBoxBlurRenderer : VolumeRendererBase<DualBoxBlur>
    {
        public override string ProfilerTag => "Blur-DualBoxBlur";
        protected override string ShaderName => "Hidden/XPostProcessing/Blur/DualBoxBlur";
