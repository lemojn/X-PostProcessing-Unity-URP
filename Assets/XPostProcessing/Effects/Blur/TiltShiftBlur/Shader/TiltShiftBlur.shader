Shader "Hidden/XPostProcessing/Blur/TiltShiftBlur"
{
    HLSLINCLUDE
    ...
    float4 Frag_TiltShiftLQ(Varyings i) : SV_Target
    {
        float4 screenColor = GetScreenColor(i.texcoord);
        float3 sum = screenColor.rgb;
        float mask = TiltShiftMask(i.texcoord);
    ...
    float4 Frag_TiltShiftHQ(Varyings i) : SV_Target
    {
        float4 screenColor = GetScreenColor(i.texcoord);
        float3 sum = screenColor.rgb;
        float mask = TiltShiftMask(i.texcoord);
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag_TiltShiftHQ
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag_TiltShiftLQ
