Shader "Hidden/XPostProcessing/Glitch/RGBSplitV5"
{
    HLSLINCLUDE
    ...
    half4 Frag_RGBSplitV5(Varyings i) : SV_Target
    {
        ...
        half colorR = GetScreenColor(i.texcoord + float2(splitAmount.x, -splitAmount.y)).r;
        half colorG = GetScreenColor(i.texcoord + float2(splitAmount.y, -splitAmount.z)).g;
        half colorB = GetScreenColor(i.texcoord + float2(splitAmount.z, -splitAmount.x)).b;
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag_RGBSplitV5
