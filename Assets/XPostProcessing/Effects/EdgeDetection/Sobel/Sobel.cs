...
{
    [VolumeComponentMenu(VolumeMenu.EdgeDetection + "Sobel")]
    public class Sobel : VolumeSettingBase
    {
    ...
    [VolumeRendererPriority(VolumePriority.EdgeDetection + 80)]
    public class SobelRenderer : VolumeRendererBase<Sobel>
    {
        public override string ProfilerTag => "EdgeDetection-Sobel";
        protected override string ShaderName => "Hidden/XPostProcessing/EdgeDetection/Sobel";
