Shader "Hidden/XPostProcessing/EdgeDetection/SobelNeon"
{
    HLSLINCLUDE
    ...
    half4 Frag_SobelNeon(Varyings i) : SV_Target
    {
        ...
        //Edge Opacity
        half3 edgeColor = lerp(backgroundColor.rgb, sceneColor.rgb, sobelGradient);
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex Vert
            #pragma fragment Frag_SobelNeon
