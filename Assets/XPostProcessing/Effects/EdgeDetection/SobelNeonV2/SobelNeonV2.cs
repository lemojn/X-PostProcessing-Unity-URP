...
{
    [VolumeComponentMenu(VolumeMenu.EdgeDetection + "Sobel Neon V2")]
    public class SobelNeonV2 : VolumeSettingBase
    {
    ...
    [VolumeRendererPriority(VolumePriority.EdgeDetection + 100)]
    public class SobelNeonV2Renderer : VolumeRendererBase<SobelNeonV2>
    {
        public override string ProfilerTag => "EdgeDetection-SobelNeonV2";
        protected override string ShaderName => "Hidden/XPostProcessing/EdgeDetection/SobelNeonV2";
