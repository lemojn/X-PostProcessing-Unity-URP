...
{
    [VolumeComponentMenu(VolumeMenu.EdgeDetection + "Roberts Neon")]
    public class RobertsNeon : VolumeSettingBase
    {
    ...
    [VolumeRendererPriority(VolumePriority.EdgeDetection + 30)]
    public class RobertsNeonRenderer : VolumeRendererBase<RobertsNeon>
    {
        public override string ProfilerTag => "EdgeDetection-RobertsNeon";
        protected override string ShaderName => "Hidden/XPostProcessing/EdgeDetection/RobertsNeon";
