Shader "Hidden/XPostProcessing/EdgeDetection/Scharr"
{
    HLSLINCLUDE
    ...
    half4 Frag_Scharr(Varyings i) : SV_Target
    {
        ...
        //Edge Opacity
        half3 edgeColor = lerp(sceneColor.rgb, _EdgeColor.rgb, scharrGradient);
